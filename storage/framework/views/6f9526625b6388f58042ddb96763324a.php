...
<div class="card">
    <div class="card-header">
        <i class="fas fa-edit me-2"></i> Edit Product: <?php echo e($product->name); ?>
...
unset($__errorArgs, $__bag); ?>" 
                               id="name" name="name" value="<?php echo e(old('name', $product->name)); ?>" placeholder="Enter product name" required>
...
unset($__errorArgs, $__bag); ?>" 
                               id="sku" name="sku" value="<?php echo e(old('sku', $product->sku)); ?>" placeholder="Enter SKU" required>
                        <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="unit" name="unit" required>
                            ...
                            <option value="litre" <?php echo e(old('unit', $product->unit) == 'litre' ? 'selected' : ''); ?>>Litre</option>
                            <option value="ml" <?php echo e(old('unit', $product->unit) == 'ml' ? 'selected' : ''); ?>>Millilitre (ml)</option>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control <?php $__errorArgs = ['cost_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               id="cost_price" name="cost_price" value="<?php echo e(old('cost_price', $product->cost_price)); ?>" placeholder="0.00" required>
...
unset($__errorArgs, $__bag); ?>" 
                               id="reorder_level" name="reorder_level" value="<?php echo e(old('reorder_level', $product->reorder_level)); ?>" placeholder="0" required>
...
unset($__errorArgs, $__bag); ?>" 
                          id="description" name="description" rows="3" placeholder="Enter product description"><?php echo e(old('description', $product->description)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ERP_Model_file\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>