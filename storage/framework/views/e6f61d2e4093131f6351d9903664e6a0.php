...
unset($__errorArgs, $__bag); ?>" 
                               id="sku" name="sku" value="<?php echo e(old('sku')); ?>" placeholder="Enter SKU" required>
                        <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="unit" name="unit" required>
                            ...
                            <option value="g" <?php echo e(old('unit') == 'g' ? 'selected' : ''); ?>>Gram (g)</option>
                            ...
                            <option value="litre" <?php echo e(old('unit') == 'litre' ? 'selected' : ''); ?>>Litre</option>
                            <option value="ml" <?php echo e(old('unit') == 'ml' ? 'selected' : ''); ?>>Millilitre (ml)</option>
...
unset($__errorArgs, $__bag); ?>" 
                               id="cost_price" name="cost_price" value="<?php echo e(old('cost_price')); ?>" placeholder="0.00" required>
...
unset($__errorArgs, $__bag); ?>" 
                               id="reorder_level" name="reorder_level" value="<?php echo e(old('reorder_level', 0)); ?>" placeholder="0" required>
...
unset($__errorArgs, $__bag); ?>" 
                          id="description" name="description" rows="3" placeholder="Enter product description"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ERP_Model_file\resources\views/admin/products/create.blade.php ENDPATH**/ ?>